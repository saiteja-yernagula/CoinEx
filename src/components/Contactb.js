  ...
  return (
    <div className='p-12'>
        <div className='py-7 text-black text-center sm:grid grid-cols-3 gap-3 '>
            <div className='max-w-sm  p-6 rounded place-content-center  shadow-lg overflow-hidden  sm:m-9 hover:scale-[1.03] '>
            ...
            <div className='max-w-sm p-6 text-center place-content-center rounded shadow-lg overflow-hidden sm:m-9 hover:scale-[1.03]'>
            ...
            <div className='max-w-sm p-6 rounded shadow-lg overflow-hidden place-content-center sm:m-9 hover:scale-[1.03]'>
         ...
         <div className='h-[100vh] text-center flex justify-center '>
            <form className='bg-gray-50 w-3/6 p-2 m-10'>
                <div><input className='outline-none w-5/6 p-4 m-3 bg-white-600' type='text' placeholder='Name'/></div>
                <div><input className='outline-none w-5/6 p-4 m-3 bg-white-600' type='text' placeholder='Email'/></div>
                <div><input className='outline-none w-5/6 p-4 m-3 bg-white-600' type='text' placeholder='Phone number'/></div>
                <div><textarea rows={7}  className='outline-none w-5/6 p-4 m-3 bg-white-600' type='text' placeholder='Message'/></div>
